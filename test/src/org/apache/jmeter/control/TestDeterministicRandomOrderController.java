...
public class TestDeterministicRandomOrderController extends JMeterTestCase {

        public TestDeterministicRandomOrderController(String name) {
            super(name);
        }

        public void testRandomOrder() {
            testLog.debug("Testing DeterministicRandomOrderController");
            DeterministicRandomOrderController roc = new DeterministicRandomOrderController();
